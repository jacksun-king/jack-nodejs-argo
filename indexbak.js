...
const ARGO_PORT = process.env.ARGO_PORT || 8078;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const S5_PORT = process.env.S5_PORT || '';                  // socks5端口，支持多端口的可以填写，否则留空
const HY2_PORT = process.env.HY2_PORT || '8980';                // hy2端口，支持多端口的可以填写，否则留空
...
const NAME = process.env.NAME || 'dcde-jack';                        // 节点名称
